    ...
    <div class="row">
        ...
        <div class="col s12 m4 l3">
            ...
            <ul id="slide-out" class="sidenav sidenav-fixed">
                ...
                <li><a href="#!"><i class="material-icons">note_add</i>Riwayat Pendidikan</a></li>
                <li><a href="{{route ('departement.index') }}"><i class="material-icons">note_add</i>Data Departemen</a></li>
                <li><a href="{{route ('gajipegawai.index') }}"><i class="material-icons">note_add</i>Gaji Pegawai</a></li>
